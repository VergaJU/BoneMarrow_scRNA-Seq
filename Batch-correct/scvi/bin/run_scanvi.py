...
# prepare and train scANVI model
scanvae = sca.models.SCANVI.from_scvi_model(vae, labels_key=args.celltype_key, unlabeled_category="Unlabelled")

print('Training scANVI model...')


scanvae.train(max_epochs=100, early_stopping=early_stopping_kwargs)
print('Done!')

# Predict celltypes
adata.obs["C_scANVI"] = scanvae.predict(adata)



# save model

ref_path = "ref_model_scANVI" + args.output_prefix
...
save_path = args.output_prefix + '_scANVI_latent.h5ad'
